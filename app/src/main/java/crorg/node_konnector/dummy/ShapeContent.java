 ...
 */
public class ShapeContent implements Serializable {
    ...
    private static ShapeItem createDummyItem(int position) {
        return new ShapeItem(String.valueOf(position), "Item " + position, makeDetails(position));
    }
    ...
    public static class ShapeItem {
        ...
        public ShapeItem(String id, String content, String details) {
            this.id = id;
